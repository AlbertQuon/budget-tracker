...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('django_tracker', '0002_rename_name_purchasecategory_category'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TransactTax',
            fields=[
                ('transact', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='django_tracker.transactions')),
